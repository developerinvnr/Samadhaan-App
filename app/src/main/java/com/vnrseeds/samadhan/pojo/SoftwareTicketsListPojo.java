...
public class SoftwareTicketsListPojo {
    private int srno;
    ...
    public SoftwareTicketsListPojo() {
    }

    public SoftwareTicketsListPojo(int srno, String ticketNo, String custodianName, String priority, String issueType, String issueTitle, String departmentName, String locationName, String sectionName, String issueDesc, String ticketStatus, String ticketDate, String assignTo, String assetCategory, String serviceType, List<String> issueImage, String ticketId, String ticketIsViewed, String ticket_priority_id, String ticket_user_id, String ticket_issue_ids, String ticket_raised_by_id, String ticket_user_type, String ticket_asset_type, String ticketAssetCatagoryID, String ticket_service_type_id, String ticket_is_work_in_progress, String ticketResolveDescription, String ticketResolveDate, String ticketEstimatedHandleDate, String ticketReplyDescription, String ticketAssetAcName, String issueName, String ticketIssueIdsStr, String ticketResolveBy, String ticketIssueOther, String raiseBy, String ticketEstimatedHandleDescription, String ticketCloseBy, String ticketCloseDate, String ticketCloseRating, String ticketCloseDescription, String ticketServiceTypeCurrentStatus, String ticketSiteVisitDescription, String ticketSiteVisitDate, String ticketReopenNumber, String behalfRaiseBy, String locationIsBaseLocation, String ticketServiceTypeIcon, String assetIsByod, String ticketModuleId, String ticketSubModuleId, String ticketIsAddToAsset, String ticketIsSiteVisit, String ticketSiteVisitAt, String ticketResolveFile, String moduleName, String subModuleName) {
        this.srno = srno;
